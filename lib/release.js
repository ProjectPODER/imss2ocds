...
function getContractItem(item) {
    ...
    if(item.hasOwnProperty('precio_unitario') && item.precio_unitario != null) Object.assign(itemObj.unit, { value: { amount: parseFloat(item.precio_unitario), quantityLostMxIMSS: 0 } });
    if(item.hasOwnProperty('monto')) Object.assign(itemObj.unit.value, { currency: 'MXN' });
